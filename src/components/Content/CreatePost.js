...
let choosePost = <h4 style={{ color: "aliceblue", textAlign: "center" }}>
  ...
  if(getUrl){
    choosePost = <YoutubePost getUrl={getUrl} choosePlayer={choosePlayer} cancelPlayer={cancelPlayer}/>
  }
  ...
  return (
    ...
    { !hideButtons ?
        ...
        <input id="file-upload" type="file" accept='image/x-png, image/jpeg' onChange={handleAddPhoto}/>
